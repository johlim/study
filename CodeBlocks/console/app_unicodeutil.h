#ifndef APP_UNICODEUTIL_H_INCLUDED
#define APP_UNICODEUTIL_H_INCLUDED
//==============================================================================
// includes
//==============================================================================
...
// defines
//==============================================================================
#ifdef	_APP_UNICODEUTIL_C_
#define		UNICODEUTIL_EXTERN
#else
#define		UNICODEUTIL_EXTERN	extern
#endif

#define	HCTBL_NOT_FOUND			0xFFFF
//#define KSC5601_CONVERT
#define UTF_8_CONVERT
//==============================================================================
// structs
//==============================================================================
...
// function prototypes
//==============================================================================
UNICODEUTIL_EXTERN unsigned char PromoteASCIItoUNICODE(unsigned char *pFileASCII, unsigned short *pFileUni);
UNICODEUTIL_EXTERN unsigned char DemoteUNICODEtoASCII(unsigned short * pFileUni, unsigned char * pASCII);

#ifdef KSC5601_CONVERT
typedef union _tHSyl_ {
...
UNICODEUTIL_EXTERN unsigned short const KSC5601_table[]
#ifdef _APP_UNICODEUTIL_C_
    = {
...
UNICODEUTIL_EXTERN unsigned short const KSC5601_KSSM2UNI_JUNG[]
#ifdef _APP_UNICODEUTIL_C_
    = {
    HCTBL_NOT_FOUND, HCTBL_NOT_FOUND, HCTBL_NOT_FOUND, 0x0000,
    0x0001, 0x0002, 0x0003, 0x0004,
    HCTBL_NOT_FOUND, HCTBL_NOT_FOUND, 0x0005, 0x0006,
    0x0007, 0x0008, 0x0009, 0x000A,
    HCTBL_NOT_FOUND, HCTBL_NOT_FOUND, 0x000B, 0x000C,
    0x000D, 0x000E, 0x000F, 0x0010,
    HCTBL_NOT_FOUND, HCTBL_NOT_FOUND, 0x0011, 0x0012,
    0x0013, 0x0014
}
#endif
;

UNICODEUTIL_EXTERN unsigned short const KSC5601_KSSM2UNI_JONG[]
#ifdef _APP_UNICODEUTIL_C_
    = {
    HCTBL_NOT_FOUND,
    0x0000, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005, 0x0006, 0x0007,
    0x0008, 0x0009, 0x000A, 0x000B, 0x000C, 0x000D, 0x000E, 0x000F,
    0x0010, HCTBL_NOT_FOUND,
...
UNICODEUTIL_EXTERN unsigned short const KSC5601_UNI2KSSM_JUNG[]
#ifdef _APP_UNICODEUTIL_C_
    = {
    0x0003, 0x0004, 0x0005, 0x0006,
    0x0007, 0x000A, 0x000B, 0x000C,
    0x000D, 0x000E, 0x000F, 0x0012,
    0x0013, 0x0014, 0x0015, 0x0016,
    0x0017, 0x001A, 0x001B, 0x001C,
    0x001D
}
#endif
;

UNICODEUTIL_EXTERN unsigned short const KSC5601_UNI2KSSM_JONG[]
#ifdef _APP_UNICODEUTIL_C_
    = {
    0x0001, 0x0002, 0x0003, 0x0004,
...
#endif // APP_UNICODEUTIL_H_INCLUDED
