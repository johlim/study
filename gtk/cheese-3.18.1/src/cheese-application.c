/* cheese-application.c generated by valac 0.30.1, the Vala compiler
...
static void cheese_application_on_help (CheeseApplication* self) {
	...
	__catch1_g_error:
	{
		...
		g_message ("cheese-application.vala:486: Error opening help: %s", _tmp5_);
		_g_error_free0 (err);
	}
	__finally1:
	if (G_UNLIKELY (_inner_error_ != NULL)) {
