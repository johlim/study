/*
 * ./src/gst-app file:///home/jhlim/test.mp3
 *
 *  ./src/gst-app https://www.freedesktop.org/software/gstreamer-sdk/data/media/sintel_cropped_multilingual.webm  --gst-debug=*:3
 */
#include <glib.h>
#include <gst/gst.h>
